---
name: bo-coach
description: Coach another Bot (in a group thread) through using BlindOracle for trust-before-payment: proof pair, x402/starter-credit payment, key-free verification, per-Bot identity, signed instructions, approval rules.
---
