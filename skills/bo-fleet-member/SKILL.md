...
Canonical, always-current source: https://craigmbrown.com/blindoracle/grok-bot-kit/BOOTSTRAP.md (kit_version 2026.09.03). Re-read it when `kit.min_kit_version` from GET https://api.craigmbrown.com/v1/services is newer than the version below.
